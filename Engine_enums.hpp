...
enum class EControllerTriggerMask {
    Left = 0,
    Right = 1,
    LeftRight = 2,
    EControllerTriggerMask_MAX = 3,
};
...
enum class EFFXCACAOQuality {
    Lowest = 0,
    Low = 1,
    Mid = 2,
    High = 3,
    Highest = 4,
    EFFXCACAOQuality_MAX = 5,
};
...
enum TextureGroup {
    ...
    TEXTUREGROUP_CH_Skin_SuperHigh = 49,
    TEXTUREGROUP_CH_Skin_High = 50,
    TEXTUREGROUP_CH_Skin_Medium = 51,
    TEXTUREGROUP_CH_Skin_Low = 52,
    TEXTUREGROUP_CH_Skin_SuperLow = 53,
    TEXTUREGROUP_CH_Hair_SuperHigh = 54,
    TEXTUREGROUP_CH_Hair_High = 55,
    TEXTUREGROUP_CH_Hair_Medium = 56,
    TEXTUREGROUP_CH_Hair_Low = 57,
    TEXTUREGROUP_CH_Hair_SuperLow = 58,
    TEXTUREGROUP_CH_Cinema_SuperHigh = 59,
    TEXTUREGROUP_CH_Cinema_High = 60,
    TEXTUREGROUP_CH_Cinema_Medium = 61,
    TEXTUREGROUP_CH_Cinema_Low = 62,
    TEXTUREGROUP_CH_Cinema_SuperLow = 63,
    TEXTUREGROUP_CH_BaseColor_SuperHigh = 64,
    TEXTUREGROUP_CH_BaseColor_High = 65,
    TEXTUREGROUP_CH_BaseColor_Medium = 66,
    TEXTUREGROUP_CH_BaseColor_Low = 67,
    TEXTUREGROUP_CH_BaseColor_SuperLow = 68,
    TEXTUREGROUP_CH_Mask_SuperHigh = 69,
    TEXTUREGROUP_CH_Mask_High = 70,
    TEXTUREGROUP_CH_Mask_Medium = 71,
    TEXTUREGROUP_CH_Mask_Low = 72,
    TEXTUREGROUP_CH_Mask_SuperLow = 73,
    TEXTUREGROUP_CH_Normal_SuperHigh = 74,
    TEXTUREGROUP_CH_Normal_High = 75,
    TEXTUREGROUP_CH_Normal_Medium = 76,
    TEXTUREGROUP_CH_Normal_Low = 77,
    TEXTUREGROUP_CH_Normal_SuperLow = 78,
    TEXTUREGROUP_CH_BentNormal_SuperHigh = 79,
    TEXTUREGROUP_CH_BentNormal_High = 80,
    TEXTUREGROUP_CH_BentNormal_Medium = 81,
    TEXTUREGROUP_CH_BentNormal_Low = 82,
    TEXTUREGROUP_CH_BentNormal_SuperLow = 83,
    TEXTUREGROUP_CH_Emissive_SuperHigh = 84,
    TEXTUREGROUP_CH_Emissive_High = 85,
    TEXTUREGROUP_CH_Emissive_Medium = 86,
    TEXTUREGROUP_CH_Emissive_Low = 87,
    TEXTUREGROUP_CH_Emissive_SuperLow = 88,
    TEXTUREGROUP_CH_ETC_SuperHigh = 89,
    TEXTUREGROUP_CH_ETC_High = 90,
    TEXTUREGROUP_CH_ETC_Medium = 91,
    TEXTUREGROUP_CH_ETC_Low = 92,
    TEXTUREGROUP_CH_ETC_SuperLow = 93,
    TEXTUREGROUP_BG_Tile_SuperHigh = 94,
    TEXTUREGROUP_BG_Tile_High = 95,
    TEXTUREGROUP_BG_Tile_Medium = 96,
    TEXTUREGROUP_BG_Tile_Low = 97,
    TEXTUREGROUP_BG_Tile_SuperLow = 98,
    TEXTUREGROUP_BG_Sky_SuperHigh = 99,
    TEXTUREGROUP_BG_Sky_High = 100,
    TEXTUREGROUP_BG_Sky_Medium = 101,
    TEXTUREGROUP_BG_Sky_Low = 102,
    TEXTUREGROUP_BG_Sky_SuperLow = 103,
    TEXTUREGROUP_BG_Cinema_SuperHigh = 104,
    TEXTUREGROUP_BG_Cinema_High = 105,
    TEXTUREGROUP_BG_Cinema_Medium = 106,
    TEXTUREGROUP_BG_Cinema_Low = 107,
    TEXTUREGROUP_BG_Cinema_SuperLow = 108,
    TEXTUREGROUP_BG_BaseColor_SuperHigh = 109,
    TEXTUREGROUP_BG_BaseColor_High = 110,
    TEXTUREGROUP_BG_BaseColor_Medium = 111,
    TEXTUREGROUP_BG_BaseColor_Low = 112,
    TEXTUREGROUP_BG_BaseColor_SuperLow = 113,
    TEXTUREGROUP_BG_Mask_SuperHigh = 114,
    TEXTUREGROUP_BG_Mask_High = 115,
    TEXTUREGROUP_BG_Mask_Medium = 116,
    TEXTUREGROUP_BG_Mask_Low = 117,
    TEXTUREGROUP_BG_Mask_SuperLow = 118,
    TEXTUREGROUP_BG_Normal_SuperHigh = 119,
    TEXTUREGROUP_BG_Normal_High = 120,
    TEXTUREGROUP_BG_Normal_Medium = 121,
    TEXTUREGROUP_BG_Normal_Low = 122,
    TEXTUREGROUP_BG_Normal_SuperLow = 123,
    TEXTUREGROUP_BG_Emissive_SuperHigh = 124,
    TEXTUREGROUP_BG_Emissive_High = 125,
    TEXTUREGROUP_BG_Emissive_Medium = 126,
    TEXTUREGROUP_BG_Emissive_Low = 127,
    TEXTUREGROUP_BG_Emissive_SuperLow = 128,
    TEXTUREGROUP_BG_ETC_SuperHigh = 129,
    TEXTUREGROUP_BG_ETC_High = 130,
    TEXTUREGROUP_BG_ETC_Medium = 131,
    TEXTUREGROUP_BG_ETC_Low = 132,
    TEXTUREGROUP_BG_ETC_SuperLow = 133,
    TEXTUREGROUP_FX_Color_SuperHigh = 134,
    TEXTUREGROUP_FX_Color_High = 135,
    TEXTUREGROUP_FX_Color_Medium = 136,
    TEXTUREGROUP_FX_Color_Low = 137,
    TEXTUREGROUP_FX_Color_SuperLow = 138,
    TEXTUREGROUP_FX_Normal_SuperHigh = 139,
    TEXTUREGROUP_FX_Normal_High = 140,
    TEXTUREGROUP_FX_Normal_Medium = 141,
    TEXTUREGROUP_FX_Normal_Low = 142,
    TEXTUREGROUP_FX_Normal_SuperLow = 143,
    TEXTUREGROUP_FX_SubUV_SuperHigh = 144,
    TEXTUREGROUP_FX_SubUV_High = 145,
    TEXTUREGROUP_FX_SubUV_Medium = 146,
    TEXTUREGROUP_FX_SubUV_Low = 147,
    TEXTUREGROUP_FX_SubUV_SuperLow = 148,
    TEXTUREGROUP_FX_SubUVNormal_SuperHigh = 149,
    TEXTUREGROUP_FX_SubUVNormal_High = 150,
    TEXTUREGROUP_FX_SubUVNormal_Medium = 151,
    TEXTUREGROUP_FX_SubUVNormal_Low = 152,
    TEXTUREGROUP_FX_SubUVNormal_SuperLow = 153,
    TEXTUREGROUP_SYS_SuperHigh = 154,
    TEXTUREGROUP_SYS_High = 155,
    TEXTUREGROUP_SYS_Medium = 156,
    TEXTUREGROUP_SYS_Low = 157,
    TEXTUREGROUP_SYS_SuperLow = 158,
    TEXTUREGROUP_ArmorAreaMask = 159,
    TEXTUREGROUP_ArmorBaseColor = 160,
    TEXTUREGROUP_ArmorEtcMask = 161,
    TEXTUREGROUP_ArmorNormal = 162,
    TEXTUREGROUP_ArmorShadeMask = 163,
    TEXTUREGROUP_BossAreaMask = 164,
    TEXTUREGROUP_BossBaseColor = 165,
    TEXTUREGROUP_BossEtcMask = 166,
    TEXTUREGROUP_BossNormal = 167,
    TEXTUREGROUP_BossShadeMask = 168,
    TEXTUREGROUP_CharacterMainAreaMask = 169,
    TEXTUREGROUP_CharacterMainBaseColor = 170,
    TEXTUREGROUP_CharacterMainEtcMask = 171,
    TEXTUREGROUP_CharacterMainNormal = 172,
    TEXTUREGROUP_CharacterMainShadeMask = 173,
    TEXTUREGROUP_HairAreaMask = 174,
    TEXTUREGROUP_HairBaseColor = 175,
    TEXTUREGROUP_HairEtcMask = 176,
    TEXTUREGROUP_HairNormal = 177,
    TEXTUREGROUP_HairShadeMask = 178,
    TEXTUREGROUP_MobAreaMask = 179,
    TEXTUREGROUP_MobBaseColor = 180,
    TEXTUREGROUP_MobEtcMask = 181,
    TEXTUREGROUP_MobNormal = 182,
    TEXTUREGROUP_MobShadeMask = 183,
    TEXTUREGROUP_NPCAreaMask = 184,
    TEXTUREGROUP_NPCBaseColor = 185,
    TEXTUREGROUP_NPCEtcMask = 186,
    TEXTUREGROUP_NPCNormal = 187,
    TEXTUREGROUP_NPCShadeMask = 188,
    TEXTUREGROUP_WeaponAreaMask = 189,
    TEXTUREGROUP_WeaponBaseColor = 190,
    TEXTUREGROUP_WeaponEtcMask = 191,
    TEXTUREGROUP_WeaponNomal = 192,
    TEXTUREGROUP_WeaponShadeMask = 193,
    TEXTUREGROUP_CharacterEffectsHigh = 194,
    TEXTUREGROUP_CharacterEffectsLow = 195,
    TEXTUREGROUP_CharacterEffectsMid = 196,
    TEXTUREGROUP_WorldEffectsHigh = 197,
    TEXTUREGROUP_WorldEffectsLow = 198,
    TEXTUREGROUP_WorldEffectsMid = 199,
    TEXTUREGROUP_BuildingBaseColor = 200,
    TEXTUREGROUP_BuildingEtcMask = 201,
    TEXTUREGROUP_BuildingNormal = 202,
    TEXTUREGROUP_BuildingShadeMask = 203,
    TEXTUREGROUP_FoliageBaseColor = 204,
    TEXTUREGROUP_FoliageEtcMask = 205,
    TEXTUREGROUP_FoliageNormal = 206,
    TEXTUREGROUP_FoliageShadeMask = 207,
    TEXTUREGROUP_GrassBaseColor = 208,
    TEXTUREGROUP_GrassEtcMask = 209,
    TEXTUREGROUP_GrassNormal = 210,
    TEXTUREGROUP_GrassShadeMask = 211,
    TEXTUREGROUP_LandscapeBaseColor = 212,
    TEXTUREGROUP_LandscapeEtcMask = 213,
    TEXTUREGROUP_LandscapeNormal = 214,
    TEXTUREGROUP_LandscapeShadeMask = 215,
    TEXTUREGROUP_NaturalPropBaseColor = 216,
    TEXTUREGROUP_NaturalPropEtcMask = 217,
    TEXTUREGROUP_NaturalPropNormal = 218,
    TEXTUREGROUP_NaturalPropShadeMask = 219,
    TEXTUREGROUP_PropBaseColor = 220,
    TEXTUREGROUP_PropEtcMask = 221,
    TEXTUREGROUP_PropNormal = 222,
    TEXTUREGROUP_PropShadeMask = 223,
    TEXTUREGROUP_TreeBaseColor = 224,
    TEXTUREGROUP_TreeEtcMask = 225,
    TEXTUREGROUP_TreeNormal = 226,
    TEXTUREGROUP_TreeShadeMask = 227,
    TEXTUREGROUP_WorldMainBaseColor = 228,
    TEXTUREGROUP_WorldMainEtcMask = 229,
    TEXTUREGROUP_WorldMainNormal = 230,
    TEXTUREGROUP_WorldMainShadeMask = 231,
    TEXTUREGROUP_ImposterBaseColor = 232,
    TEXTUREGROUP_ImposterOpacityMask = 233,
    TEXTUREGROUP_ImposterNormal = 234,
    TEXTUREGROUP_WorldBaseColorLow = 235,
    TEXTUREGROUP_WorldEtcMaskLow = 236,
    TEXTUREGROUP_WorldNormalLow = 237,
    TEXTUREGROUP_WorldShadeMaskLow = 238,
    TEXTUREGROUP_CharacterBaseColorLow = 239,
    TEXTUREGROUP_CharacterEtcMaskLow = 240,
    TEXTUREGROUP_CharacterNormalLow = 241,
    TEXTUREGROUP_CharacterShadeMaskLow = 242,
    TEXTUREGROUP_MAX = 243,
};
