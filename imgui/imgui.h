...
namespace ImGui
{
    ...
    IMGUI_API void          ProgressBar(float fraction, const ImVec2& size_arg = ImVec2(-FLT_MIN, 0), const char* overlay = NULL, const ImVec4& progressColor = ImVec4(0.9f, 0.7f, 0.0f, 1.0f));
